...
def submit_form(request):
      ...
      'Authorization': 'bearer ' + token
        ...
        data = {
            ...
            'starting_date': (request.GET.get('startingDate')),
            'end_date': (request.GET.get('endDate')),
            'is_overtime': (request.GET.get('isOvertime')),
            'is_location_bound': (request.GET.get('isLocationBound')),
            'location': (request.GET.get('location')),
            'workday_start': (request.GET.get('workdayStart')),
            'workday_end': (request.GET.get('workdayEnd')),
